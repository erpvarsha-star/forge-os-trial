...
import { LogOut, Globe, Crown } from 'lucide-react-native'
      ...
      <ScrollView className="flex-1 p-4">
        <Card className="mb-4">
          <View className="flex-row items-center gap-4">
            <View className="w-16 h-16 bg-orange-100 rounded-full items-center justify-center"><Crown size={28} color="#E65C00" /></View>
