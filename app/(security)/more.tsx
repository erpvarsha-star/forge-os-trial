...
/**
 * Security had no "more" tab at all — no logout option anywhere in the
 * role. Found and fixed 24 Sep 2026. Mirrors every other role group's
 * more.tsx (see e.g. (manager)/more.tsx).
 */
      ...
      <ScrollView className="flex-1 p-4" contentContainerStyle={{ paddingBottom: 32 }}>
        <Card className="mb-4">
          <View className="flex-row items-center gap-4">
            <View className="w-16 h-16 bg-brand-50 rounded-full items-center justify-center"><ShieldCheck size={28} color={BRAND[600]} /></View>
