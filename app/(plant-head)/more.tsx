...
import { LogOut, Globe, Shield, ChevronRight, Eye } from 'lucide-react-native'
import { BRAND } from '@/components/theme'

export default function PlantHeadMore() {
      ...
      <ScrollView className="flex-1 p-4" contentContainerStyle={{ paddingBottom: 32 }}>
        <Card className="mb-4">
          <View className="flex-row items-center gap-4">
            <View className="w-16 h-16 bg-brand-50 rounded-full items-center justify-center"><Shield size={28} color={BRAND[600]} /></View>
