...
--    five_s_score.
--    Guarded so re-running this script after it already succeeded once
--    doesn't error with "column 5s_score does not exist" — it just skips
--    the rename if it's already been done.
DO $$
BEGIN
  IF EXISTS (
